...
C                q2:in adt1:in adt2:in
C
C
C
C
C
      SUBROUTINE FLUX_FACE_D(x1, x2, q1, q1d, q2, q2d, adt1, adt1d, adt2
     +                       , adt2d, res1, res1d, res2, res2d)
      IMPLICIT NONE
...
C
     ...
     +       (4)
      REAL*8 q1d(4), q2d(4), adt1d, adt2d, res1d(4), res2d(4), mud, r1id
     +       , u1d, v1d, p1d, vol1d, r2id, u2d, v2d, p2d, vol2d, fd(4)
      INTEGER ii1
C
C
      dx = x1(1) - x2(1)
...
C
      ...
      fd(2) = 0.5d0*(vol1d*q1(2)+vol1*q1d(2)+dy*p1d+vol2d*q2(2)+vol2*q2d
     +  (2)+dy*p2d)
      f(2) = 0.5d0*(vol1*q1(2)+p1*dy+vol2*q2(2)+p2*dy)
      fd(3) = 0.5d0*(vol1d*q1(3)+vol1*q1d(3)-dx*p1d+vol2d*q2(3)+vol2*q2d
     +  (3)-dx*p2d)
