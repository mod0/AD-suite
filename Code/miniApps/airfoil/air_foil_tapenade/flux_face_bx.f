...
C   gradient     of useful results: res1 res2 q1 q2 x1 x2 adt1
C                adt2
C   with respect to varying inputs: res1 res2 q1 q2 x1 x2 adt1
C                adt2
C   RW status of diff variables: res1:in-out res2:in-out q1:incr
C                q2:incr x1:incr x2:incr adt1:incr adt2:incr
C
C
C
C
C
      SUBROUTINE FLUX_FACE_BX(x1, x1b, x2, x2b, q1, q1b, q2, q2b, adt1,
     +                       adt1b, adt2, adt2b, res1, res1b, res2, 
     +                       res2b)
      IMPLICIT NONE
...
C
     ...
     +       (4)
      REAL*8 x1b(2), x2b(2), q1b(4), q2b(4), adt1b, adt2b, res1b(4), 
     +       res2b(4), dxb, dyb, mub, r1ib, u1b, v1b, p1b, vol1b, r2ib, 
     +       u2b, v2b, p2b, vol2b, fb(4)
      REAL*8 tempb5
      REAL*8 tempb4
      REAL*8 tempb3
      REAL*8 tempb2
...
C
     ...
     +  tempb
      dxb = (-p2-p1)*tempb0 - v1*vol1b - v2*vol2b
      dyb = u2*vol2b + u1*vol1b + (p2+p1)*tempb2
