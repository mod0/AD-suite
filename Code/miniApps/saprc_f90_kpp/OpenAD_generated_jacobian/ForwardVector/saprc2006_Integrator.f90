...
MODULE saprc2006_Integrator

  USE saprc2006_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE saprc2006_Parameters, ONLY: NVAR, LU_NONZERO
 USE saprc2006_Global, ONLY: FIX, RCONST, TIME
 USE saprc2006_Function, ONLY: Fun_OAD
 USE saprc2006_Rates, ONLY: Update_SUN, Update_RCONST
 USE oad_active
!~~~> Input variables
...
!~~~> OpenAd variables
   TYPE(active) :: Y_OAD(NVAR)
   TYPE(active) :: Ydot_OAD(NVAR)
!~~~> iteration variables
   INTEGER :: i, j
   ...
   CALL Fun_OAD( Y_OAD, FIX, RCONST, Ydot_OAD )
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE saprc2006_Parameters, ONLY: NVAR, LU_NONZERO
 USE saprc2006_Global, ONLY: FIX, RCONST, TIME
 USE saprc2006_JacobianSP, ONLY: LU_IROW, LU_ICOL !, Jac_SP
 USE saprc2006_Function, ONLY: Fun_OAD
 USE saprc2006_LinearAlgebra
 USE saprc2006_Rates, ONLY: Update_SUN, Update_RCONST
 USE oad_active
...
!~~~> Local variables
    ...
    END DO
    DO i=1,LU_NONZERO
         Jcb(i,j) = Ydot_OAD(i)%d(j)
    END DO
#else
    !CALL Jac_SP( Y, FIX, RCONST, Jcb )
    CALL Fun_OAD( Y_OAD, FIX, RCONST, Ydot_OAD )

    ! Copy values from Ydot_OAD
    DO i=1,LU_NONZERO
       Jcb(i) = Ydot_OAD(LU_IROW(i))%d(LU_ICOL(i))
!       write (*,"(e23.16, $)") Jcb(i)
    END DO
!    write (*,*) ""
#endif
...
END MODULE saprc2006_Integrator
