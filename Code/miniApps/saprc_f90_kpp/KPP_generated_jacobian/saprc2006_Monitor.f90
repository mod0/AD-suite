...
MODULE saprc2006_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'NO2            ','RO2_N          ','RO2_R          ', &
     'RCO_O2         ','AIR            ','O2             ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(3) :: SPC_NAMES_1 = (/ &
     'H2O            ','H2             ','CH4            ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(93) :: SPC_NAMES = (/&
    SPC_NAMES_0, SPC_NAMES_1 /)

  INTEGER, PARAMETER, DIMENSION(93) :: LOOKAT = (/ &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '        HO2 + NO2 --> HNO4                                                                          ', &
     '             HNO4 --> HO2 + NO2                                                                     ', &
     '             HNO4 --> 0.61 HO2 + 0.39 OH + 0.39 NO3 + 0.61 NO2                                      ', &
     '        HNO4 + OH --> NO2                                                                           ', &
     '         O3 + HO2 --> OH                                                                            ', &
     '            2 HO2 --> H2O2                                                                          ', &
     '      2 HO2 + H2O --> H2O2                                                                          ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '             ACET --> C_O2 + CCO_O2                                                                 ', &
     '         MEK + OH --> 0.616 R2O2 + 0.482 CCHO + 0.115 HCHO + 0.37 RCHO + 0.492 CCO_O2 ... etc.      ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '   METHACRO + O3P --> RCHO                                                                          ', &
     '         METHACRO --> 0.67 CO + 0.67 HCHO + 0.34 HO2 + 0.33 OH + 0.33 MA_RCO3 ... etc.              ', &
     '         MVK + OH --> 0.3 MGLY + 0.675 R2O2 + 0.3 HCHO + 0.675 RCHO + 0.675 CCO_O2 ... etc.         ', &
     ...
     '            PROD2 --> 0.515 R2O2 + 0.246 CCHO + 0.506 HCHO + 0.71 RCHO + 0.667 CCO_O2 ... etc.      ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '             DCB2 --> CO + 0.5 MGLY + 0.5 GLY + R2O2 + 0.5 HO2 + 0.5 CCO_O2 ... etc.                ', &
     '        DCB3 + OH --> R2O2 + RCHO + CCO_O2                                                          ', &
     '             DCB3 --> CO + 0.5 MGLY + 0.5 GLY + R2O2 + 0.5 HO2 + 0.5 CCO_O2 ... etc.                ', &
     '         OH + CH4 --> C_O2                                                                          ', &
     ...
     '   ISOPRENE + NO3 --> 0.187 R2O2 + 0.936 ISOPROD + 0.187 NO2 + 0.064 RO2_N ... etc.                 ', &
     '   ISOPRENE + O3P --> 0.24 R2O2 + 0.24 HCHO + 0.75 PROD2 + 0.24 MA_RCO3 + 0.25 C_O2 ... etc.        ', &
     ...
     '       TERP + NO3 --> 0.75 R2O2 + 0.276 RNO3 + 0.474 RCHO + 0.474 NO2 + 0.25 RO2_N ... etc.         ', &
     '       TERP + O3P --> 0.147 RCHO + 0.853 PROD2                                                      ', &
     '        C2H6 + OH --> CCHO + RO2_R                                                                  ', &
     '        C3H8 + OH --> 0.704 ACET + 0.261 RCHO + 0.035 RO2_N + 0.965 RO2_R ... etc.                  ', &
     '        C2H2 + OH --> 0.297 HCOOH + 0.393 CO + 0.607 GLY + 0.096 HCHO + 0.297 HO2 ... etc.          ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(25) :: EQN_NAMES_7 = (/ &
     ...
     '        C3H6 + OH --> 0.048 XC + 0.984 CCHO + 0.984 HCHO + 0.016 RO2_N + 0.984 RO2_R ... etc.       ', &
     '        C3H6 + O3 --> 0.135 CO2 + 0.185 HCOOH + 0.17 CCO_OH + 0.07 XC + 0.51 CO ... etc.            ', &
     ...
     '              DMS --> AIR                                                                           ', &
     '              CO2 --> AIR                                                                           ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(235) :: EQN_NAMES = (/&
