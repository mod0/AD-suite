...
subroutine sparse_solve1(A, b, x)
    ...
    !call sparse_dummy_method1(A, b, x)
...
subroutine sparse_solve2(arows, acols, annz, arow_index, acol_index, avalues, b, x)
    ...
    !call sparse_dummy_method2(arows, acols, annz, arow_index, acol_index, avalues, b, x)
...
!
subroutine sparse_dummy_method1(A, b, x)
        integer :: i
        ...
        x = b/sum
end subroutine sparse_dummy_method1

!
! A method to test OpenAD without solver
!
subroutine sparse_dummy_method2(arows, acols, annz, arow_index, acol_index, avalues, b, x)
        integer :: i
        double precision :: sum
        integer :: arows, acols, annz
        integer, dimension(:) :: arow_index
