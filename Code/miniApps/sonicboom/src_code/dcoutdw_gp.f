...
C
      ...
      integer*4 isp,is,kn,kw,jt,ia,ib,iwhico,iwhiex
      real*8
     .  u2,pression(4),adjoi(4),dpdw(5,4),grap(3),xgrapn,xdpdw(5),
     .  diff,diff1,diff2,ccl,ccd,usro,yx,xe,xshape,ybelow,yextra,
...
c          xgrapn = grap(1)*grap(1)                         !ojo, prueba...
