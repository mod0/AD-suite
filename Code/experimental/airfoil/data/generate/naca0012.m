...
%
% Mike Giles, Gihan Mudalige, István Reguly, Carlo Bertolli,
% Lawrence Mitchell and several other collaborators listed here:
%
% http://www.oerc.ox.ac.uk/projects/op2
%
% In particular, this file was originally authored by Carlo Bertolli 
% and subsequently expanded by Florian Rathgeber (as of 4 Aug 2015)
% 
% The link to the git project is:
...
%
if(nargin < 3)
    I = 400;                      % Increase I and J to generate 
    J = 600;                      % larger meshes.
end
